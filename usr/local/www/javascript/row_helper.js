...
var addRowTo = (function() {
	...
	for (i = 0; i < field_counter_js; i++) {
		...
		if(typeof(rowtype[i]) == 'function') {
			...
			td.innerHTML="<INPUT type='hidden' value='" + totalrows +"' name='" + rowname[i] + "_row-" + totalrows + "'></input><input type='password' size='" + rowsize[i] + "' name='" + rowname[i] + totalrows + "' id='" + rowname[i] + totalrows + "'></input> ";
